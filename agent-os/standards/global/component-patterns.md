...
">
  <nav className="container mx-auto px-4 h-16 flex items-center justify-between">
    ...
    <div className="hidden md:flex items-center gap-6">
      <a href="/features" className="text-sm font-medium text-text-primary hover:text-brand-primary transition-colors">
        Features
      </a>
      <a href="/pricing" className="text-sm font-medium text-text-primary hover:text-brand-primary transition-colors">
        Pricing
      </a>
      <a href="/about" className="text-sm font-medium text-text-primary hover:text-brand-primary transition-colors">
        About
      </a>
    </div>
