...
- `yoyo-dev/specs/[this-spec]/spec.md` (if present)
- `yoyo-dev/specs/[this-spec]/planning/requirements.md` (if present)
- `yoyo-dev/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `yoyo-dev/specs/[this-spec]/tasks.md`
