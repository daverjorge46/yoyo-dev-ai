...
Read `yoyo-dev/specs/[this-spec]/tasks.md` to review the available task groups, then output the following message to the user and WAIT for their response:
...
- The specific task group(s) from `yoyo-dev/specs/[this-spec]/tasks.md` including the parent task, all sub-tasks, and any sub-bullet points
- The path to this spec's documentation: `yoyo-dev/specs/[this-spec]/spec.md`
- The path to this spec's requirements: `yoyo-dev/specs/[this-spec]/planning/requirements.md`
- The path to this spec's visuals (if any): `yoyo-dev/specs/[this-spec]/planning/visuals`

Instruct the subagent to:
1. Analyze the provided spec.md, requirements.md, and visuals (if any)
2. Analyze patterns in the codebase according to its built-in workflow
3. Implement the assigned task group according to requirements and standards
4. Update `yoyo-dev/specs/[this-spec]/tasks.md` to mark completed tasks with `- [x]`
...
- The path to this spec: `yoyo-dev/specs/[this-spec]`
Instruct the subagent to do the following:
  1. Run all of its final verifications according to its built-in workflow
  2. Produce the final verification report in `yoyo-dev/specs/[this-spec]/verifications/final-verification.md`.
