...
<pattern_extraction>
  <source_files>
    - context.md - Implementation patterns used
    - decisions.md - Technical choices made
    - Key implementation files
  </source_files>
  <patterns_to_capture>
    - Reusable architectural patterns
    - Successful authentication/security approaches
    - Effective form validation strategies
...
<state_finalization>
  ...
  <updates>
    - execution_completed: [CURRENT_DATE]
    - current_phase: "completed"
    - pr_url: [PR_URL_FROM_STEP_2]
    - active_task: null
  </updates>
</state_finalization>
