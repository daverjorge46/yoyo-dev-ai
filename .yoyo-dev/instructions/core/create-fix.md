...
<investigation_approach>
  <locate_code>
    ...
    - Review recent changes (git log if relevant)
  </locate_code>
  <analyze_code>
...
<analysis_framework>
  ...
  <verification>
    - Does the diagnosis explain all symptoms?
...
<task_creation_guidelines>
  <parent_tasks>
    - Typically 2-4 parent tasks for fixes
    - First task: Always reproduction tests
    - Middle tasks: Implementation changes
    - Last task: Always verification
  </parent_tasks>
  <subtasks>
    - Maximum 8 per parent task
    - Specific and actionable
    - Include file paths and line ranges when possible
    - Always include test verification
  </subtasks>
  <tdd_approach>
