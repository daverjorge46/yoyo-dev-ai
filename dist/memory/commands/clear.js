 ...
 */
export function clearSession(service, agentId, options = {}) {
 ...
 */
export function verifyMemoryIntact(service) {
    const blocks = service.getAllBlocks();
    return {
 ...
 */
export async function clearCommand(service, agentId, options = {}) {
    // Clear session
