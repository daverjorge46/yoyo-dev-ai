 ...
 */
export type MemoryBlockContent = PersonaContent | ProjectContent | UserContent | CorrectionsContent;
/**
 ...
 */
export type MemoryErrorCode = 'DB_ERROR' | 'BLOCK_NOT_FOUND' | 'SCOPE_ERROR' | 'VALIDATION_ERROR' | 'INIT_ERROR' | 'PERMISSION_ERROR';
/**
...
export declare class MemoryError extends Error {
    ...
    constructor(message: string, code: MemoryErrorCode, details?: Record<string, unknown> | undefined);
}
/**
