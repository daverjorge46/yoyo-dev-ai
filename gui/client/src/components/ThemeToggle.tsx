...
function getStoredTheme(): ThemeMode {
  if (typeof window !== 'undefined') {
    const stored = localStorage.getItem('yoyo-theme') as ThemeMode | null;
            ...
            {(['dark', 'light', 'system'] as ThemeMode[]).map((mode) => (
              <button
                ...
                className={`
                  ...
                  ${
                    theme === mode
                      ? 'bg-brand/10 text-brand dark:bg-terminal-orange/10 dark:text-terminal-orange'
              ...
              >
                ...
                {theme === mode && (
                  <svg className="h-4 w-4 ml-auto text-brand dark:text-terminal-orange" fill="currentColor" viewBox="0 0 20 20">
