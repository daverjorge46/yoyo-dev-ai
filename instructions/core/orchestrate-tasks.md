...
<instructions>
  ...
  AVAILABLE_STANDARDS:
    ...
    - design-system.md (UI/design standards)
    - parallel-execution.md (task execution)
    - personas.md (development approach)
    - code-style/*.md (language-specific styles)
...
<instructions>
  ...
  REQUEST: "Complete git workflow for [SPEC_NAME] feature:
            ...
            - Orchestration: Used multi-agent orchestration
            - Create commit and push
            - Create pull request with orchestration summary"
...
<instructions>
  ...
  REQUEST: "Complete post-execution tracking for [SPEC_NAME]:
            - Verify all orchestrated tasks marked complete in tasks.md
            - Update roadmap.md if applicable
            - Create recap in .yoyo-dev/recaps/
            - Generate completion summary with:
              * PR URL
              * Orchestration strategy used
              * Agents involved
              * Total time saved via parallel execution"
